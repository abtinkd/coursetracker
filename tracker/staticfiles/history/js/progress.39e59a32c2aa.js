 $(document).ready(function () {
  ...
  /*FOR DEMO ONLY*/
    ...
    function modifyProgressVal(type) {
		...
		{
			$('.progress').css("background", "rgba(1, 23, 43, 1)");
			$('.progress').css("background", "-webkit-linear-gradient(top, rgba(146, 3, 255, 1) 0%, rgba(1, 23, 43, 1) 100%)");
			$('.progress').css("background", "linear-gradient(to bottom, rgba(146, 3, 255, 1) 0%, rgba(1, 23, 43, 1) 100%)");
		}
